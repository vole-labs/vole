#ifndef VOLE_TWO_KEY_PRP_H__
#define VOLE_TWO_KEY_PRP_H__
// GGM node expander, vendored from emp-ot 0.3.0 (emp-ot/ferret/twokeyprp.h,
// MIT/Apache-2.0); removed upstream in the 1.0 rewrite (cGGM). Uses only
// emp-tool's AES_KEY / AES_set_encrypt_key / ParaEnc<K,N>.
